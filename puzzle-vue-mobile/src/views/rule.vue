<template>
  <div class="container">
    ...
    <!--card-->
    <div class="box" v-if="rule1=='#43CF7C' && rule2=='#fff' && rule3=='#fff'">
      <div class="img">
    ...
    <div class="box" v-if="rule1=='#43CF7C' && rule2=='#5679CB' && rule3=='#fff'">
      <div class="img">
        <div class="content-box">
    ...
    <div class="box" v-if="rule1=='#43CF7C' && rule2=='#5679CB' && rule3=='#D43030' && rule4==1">
      <div class="img">
        <div class="content-box">
